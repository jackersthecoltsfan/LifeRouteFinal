...
- Checked-in `LifeRoute/`, `LifeRouteLiveActivityWidget/`, and `LifeRoute.xcodeproj/` are the canonical v0.8.1 shipping source. Never reconstruct current development by replaying archived v0.x patches.
