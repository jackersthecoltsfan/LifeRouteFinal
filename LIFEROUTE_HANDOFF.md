# Living Themes direct-launch QA harness qualified — September 11, 2026

- The DEBUG launch flag `-LifeRouteLivingThemeQAViewer` selects the engineering harness before constructing normal ContentView or product navigation. Optional `-LifeRouteLivingThemeQAScene <registry-id>` selects transient initial scenery. Ordinary launch stays on the original product path. There is no mounted-product QA entry, return route, root substitution, or Setup restoration logic.
- One existing production `LifeRouteLiveThemeEnvironment` renders the selected central scene. Pause uses the existing animation policy; Reduce Motion uses existing calm quality. No renderer, shader, artwork, scene configuration, or family timing changes are part of this tooling milestone.
- Exact QA interactive contract: hidden = `livingQA.toggleControls`; revealed = that button plus `livingQA.previous`, `livingQA.next`, `livingQA.pause`, `livingQA.reduceMotion`, `livingQA.session`. End QA releases the surface; Restart QA recreates one production authority. No Menu, Toggle, unnamed interaction, or product navigation.
- Xcode 27 Debug direct isolation PASS (6.945 s); twelve-scene viewer runtime PASS (30.405 s); separate normal five-root / Setup state regression PASS (12.637 s). Production native suite PASS, 534 assertions including paired transitions, rapid selection, lifecycle, calm/constrained policy, and bounded resource release. Actual scene background observation records zero renderer/resource/clock owners. Normal product trace records one renderer/resource owner. Whole-process QA and normal preference-file hashes and modification times remain unchanged.
- Actual Release binary excludes all twelve checked QA names/flags/identifiers; positive Debug controls include them. Actual Release launch with both QA flags opens the normal product and passes five-root / Setup checks (11.925 s). No QA entry is available in normal navigation. Simulator verification is not physical acceptance.
- Worktree `/Users/brand/Documents/GitHub/LifeRouteFinal-living-themes-motion-refinement`, branch `codex/living-themes-motion-refinement-20260910`, tooling parent `f1f67fbe83f4f36d84b4759e9c2933ffc26b67e5`. Exact tooling commit and artifacts are recorded outside the source tree in `continuation-direct-launch/VIEWER_QUALIFICATION_RECEIPT.md` under `/Users/brand/Documents/LifeRouteCheckpoints/living-themes-motion-refinement-20260910`.
- All twelve unchanged baselines are now sealed at the external checkpoint in `perceptibility/BASELINE_RECEIPT.md` and `baseline-evidence-sha256.json`. Mountains Night is the first refined scene to pass: broad lake motion independent of atmosphere, layered wisps/clouds, ridge spindrift, and varied20–30-second meteor arrivals. Native primary spread89.533%, moving median7.333/255, fixed control0%; all12 viewer runtime, Rainforest/Arctic GPU controls, focused14 GPU assertions and147 deterministic assertions pass. See `refinements/mountains-night/SCENE_RECEIPT.md` for exact scene SHA and source/artifact/evidence identity. Remaining scene refinements and final validation/signing are still pending; do not infer a full candidate PASS. Keep the original motion thresholds, Ocean spatial/temporal contract and protected Rainforest Day/Ocean timing authority.
- Mountains Day also passes: full lake/inlet motion independent of secondary atmosphere, irregular wind ripples, localized grass/gusts, stronger clouds. Final native primary spread98.138%, median8/255, static0%,11.951s samples/13.065s movie;17focused GPU assertions, all12 native runtime and unchanged Rainforest/Arctic/Mountains Night controls pass. GPU PASS now requires the frozen whole-primary ROI magnitude/spread/static floor in addition to prior contribution probes. Exact scene SHA and evidence are in `refinements/mountains-day/SCENE_RECEIPT.md`; other scenes and final candidate validation remain pending.
- Canyon Day passes: artwork-aligned winding river flow independent of atmosphere, stronger clouds and bounded sunset shafts. Original ROI remains required; added accurate entire-water gate measured on the same unchanged baseline and refined capture. Native full-water spread88.304%, median8.667/255, fixed control0%;19GPU assertions, all12 native runtime, Rainforest/Arctic controls and preflight pass. See `refinements/canyon-day/SCENE_RECEIPT.md` for exact source/evidence. Canyon Night and other scene refinements remain pending.
- Canyon Night passes with full-channel flow, dark-water motion, stronger clouds, linked local moonlight/reflection and river mist. Native complete-water spread90.980%, median7.000/255, static0%;20GPU assertions, all12 native runtime and Rainforest/Arctic/Canyon Day controls pass. Original primary gate remains required alongside the additional accurate water polygon. See `refinements/canyon-night/SCENE_RECEIPT.md` for exact evidence and resolved local receipt-ID errors. Remaining Rainforest Night, Arctic, Desert, Ocean work and final validation are pending.
- Rainforest Night passes with added canopy clouds and localized foliage/gusts. Its original water program and accepted Day shader remain byte-exact. Native primary spread41.609%, median8.667/255, static0%;15GPU assertions, all12 native runtime and Rainforest Day/Arctic controls pass. Exact scene/evidence is in `refinements/rainforest-night/SCENE_RECEIPT.md`. Arctic, Desert, Ocean and final validation remain pending.
- Arctic Day passes after a local shoreline correction. Original snow style now has10x eligible particle cells; slow channel water stays independent of atmosphere. Native weather spread57.108%, water spread95.350%; original and added shelf-edge static controls0%.21GPU assertions/all12 runtime pass;288Rainforest Day/Arctic Night/Mountains Night control images remain pixel-identical. Initial isolated shelf-edge failure and final evidence are preserved in `refinements/arctic-day/SCENE_RECEIPT.md`. Arctic Night, Desert, Ocean and final validation remain pending.
- Arctic Night passes with three independently evolving aurora curtains and reflected aurora light on fixed cracked ice. Native primary spread90.160%, median10.333/255, static0%;17GPU assertions, all12 runtime and Rainforest Day/Canyon Night/Arctic Day controls pass. See `refinements/arctic-night/SCENE_RECEIPT.md`. Desert, Ocean and final validation remain pending.
- Desert Night passes with basin dust/gusts, slow star drift and varied8–15second meteors. A local angular haze edge was corrected before commit. All18GPU assertions/all12 runtime and Rainforest/Arctic/Canyon controls pass; exact native metrics and39.848second celestial evidence are in refinements/desert-night/SCENE_RECEIPT.md. Desert Day, Ocean and final validation remain pending.
- Desert Day passes with four heat-depth zones, layered sand gusts and active clouds. Native primary spread57.940%, median19.667/255, static0%;17GPU assertions/all12runtime and Rainforest Day/Desert Night/Arctic Day controls pass. Exact evidence is in refinements/desert-day/SCENE_RECEIPT.md. Ocean and final validation remain pending.
- Ocean Day passes with broader swells, continuous water motion across three depths, fine foam and stronger clouds under unchanged frozen timing. Two local foam drafts were corrected before commit.206GPUassertions/all12runtime, original floors and supplemental simultaneous-depth/energy gates pass. Exact capture, phase/overlap and per-depth evidence is in refinements/ocean-day/SCENE_RECEIPT.md. Ocean Night and final validation remain pending.
- Ocean Night passes with broad dark-water motion, fragmented moon trail and stronger clouds, preserving moon/horizon and frozen timing. Native full-water spread97.756%, median20.667/255, fixed0%;209GPUassertions/all12runtime, original and supplemental spatial gates pass. All twelve scenes now have scene engineering PASS (Rainforest Day unchanged). Final complete product/runtime/performance/Release validation and signed-candidate gates remain pending; see refinements/ocean-night/SCENE_RECEIPT.md.
- No physical install, Session Note, Calendar B, TestFlight, release, hosted CI, push, merge, or second worker. Prior failed draft histories and patches are preserved externally. Do not revive their mounted-product QA architecture.
