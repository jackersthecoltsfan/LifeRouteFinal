...
- Next: capture unchanged baselines for all twelve scenes through this unobstructed harness; define artwork-specific primary/static ROIs and retain the 2/255 threshold, 3/255 moving median, 25% general / 40% Ocean spread, <=5% static exceedance, >=10 s general / >=20 s Ocean capture, and distributed Ocean phase contract before scene edits. Scene refinements and final candidate remain unqualified until those gates pass. Rainforest Day and frozen Ocean timing remain protected.
