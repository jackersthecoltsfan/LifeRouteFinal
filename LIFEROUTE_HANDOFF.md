...
- Exact-candidate bright-scene review exposed pale header copy. Only the introductory header subtitles/count captions, Boards introduction and Today date text now use the existing fixed day/night secondary reading roles. This adds no plane, tint, shadow or layout change and does not retune tokens or theme hues.
