...
struct LifeRouteDynamicMotionSignature {
    let speed: Double
    let amplitude: CGFloat
...
extension LifeRouteTheme {
    var dynamicMotionSignature: LifeRouteDynamicMotionSignature {
        switch self {
...
// v0.7.1 Royal Current exemplar: broad layered glass-current artwork driven only by the root phase.
...
// MARK: - v0.7.1 retained Dynamic production renderers
...
extension LifeRouteTheme {
    ...
    var v071SceneryAssetName: String? {
        switch self {
