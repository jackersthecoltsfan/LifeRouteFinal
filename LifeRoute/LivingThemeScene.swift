...
struct LivingThemeScene: Equatable, Sendable {
    ...
    static let arcticNight = Self(themeIdentifier: "scenery.arctic.night", artworkName: "SceneryArcticNight",
        fragmentFunction: "livingArcticNightFragment", atmosphere: .arcticNight)
    static let mountainsDay = Self(themeIdentifier: "scenery.mountains.day", artworkName: "SceneryMountainsDay",
        fragmentFunction: "livingMountainsFragment", atmosphere: .mountainsDay)
    static let mountainsNight = Self(themeIdentifier: "scenery.mountains.night", artworkName: "SceneryMountainsNight",
    ...
    static let desertDay = Self(themeIdentifier: "scenery.desert.day", artworkName: "SceneryDesertDay",
        fragmentFunction: "livingDesertFragment", atmosphere: .desertDay)
    static let desertNight = Self(themeIdentifier: "scenery.desert.night", artworkName: "SceneryDesertNight",
        fragmentFunction: "livingDesertFragment", atmosphere: .desertNight)
...
struct LivingThemeRegistration: Equatable, Sendable {
    ...
    static let all: [Self] = [
        ...
        .init(themeIdentifier: "scenery.arctic.night", family: .arctic, variant: .night, scene: .arcticNight,
        ...
        .init(themeIdentifier: "scenery.mountains.day", family: .mountains, variant: .day, scene: .mountainsDay,
              primaryMotion: "advecting reforming clouds and valley fog", secondaryEffects: ["depth haze", "lake ripples"], ambientEffects: []),
        .init(themeIdentifier: "scenery.mountains.night", family: .mountains, variant: .night, scene: .mountainsNight,
        ...
        .init(themeIdentifier: "scenery.desert.day", family: .desert, variant: .day, scene: .desertDay,
        ...
        .init(themeIdentifier: "scenery.desert.night", family: .desert, variant: .night, scene: .desertNight,
