...
(() => {
  ...
  style.textContent = `
    ...
    .view.active,.lrSetupPane.active,#lifeRouteSetupHubV2:not([hidden]),.lrSessionToolsHub:not([hidden]){animation:lrPageEnter .22s cubic-bezier(.16,1,.3,1) both;}@keyframes lrPageEnter{from{opacity:.14;transform:translate3d(0,8px,0) scale(.995)}to{opacity:1;transform:translate3d(0,0,0) scale(1)}}
