...
(() => {
  ...
  style.textContent = `
    ...
    @media(max-width:680px){.toolGrid{grid-template-columns:1fr}.firstThenBoard{grid-template-columns:1fr;gap:9px;height:calc(100% - 60px)}.firstThenPanel{min-height:34vh;border-radius:22px}.firstThenArrow{transform:rotate(90deg);justify-self:center}.firstThenValue{font-size:clamp(34px,12vw,58px)}}
  `;
