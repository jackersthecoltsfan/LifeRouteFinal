...
(() => {
  ...
  styles.textContent = `
    ...
    .firstThenVisualImage{width:min(49vw,420px);max-height:50vh;object-fit:contain;border-radius:24px;background:white;border:0;box-shadow:0 16px 48px rgba(0,0,0,.18);margin-bottom:0}.firstThenPanel.visualReady .firstThenValue{display:none}
