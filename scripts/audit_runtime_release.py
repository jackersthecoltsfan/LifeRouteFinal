...
require('overlayClassObserver.observe(overlay' in first_then, "First/Then class observer is overlay-scoped")
require('overlayContentObserver.observe(overlay' in first_then, "First/Then content observer is overlay-scoped")
