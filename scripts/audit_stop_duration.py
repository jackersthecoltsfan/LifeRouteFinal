...
require("wrapBoundarySave" in stop, "searched boundary stops auto-prompt duration")
require("[data-boundary-place],[data-boundary-todo]" in stop, "direct saved-place and To-Do stops auto-prompt duration")
require("wrapGapPlanner" in stop and "pendingGapPrompt" in stop, "between-event stops auto-prompt duration")
require("generateLifeRouteDay" in stop, "active Live Day refresh after duration change")
require("const kind = state.kind" in stop, "duration type preserved before closing editor")
require("redraw(kind)" in stop, "correct boundary/gap card redraw after duration update")
