...
require("schemaVersion: Int = 3" in store and "max(3, input.schemaVersion)" in store, "Native snapshot schema advances deterministically while retaining 04B fields")
...
require("sanitizedManualCalendarEvents(events)" in store, "Only sanitized manual LifeRoute appointments are accepted by persistent calendar storage")
