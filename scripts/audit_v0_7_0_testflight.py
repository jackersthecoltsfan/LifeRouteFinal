...
require_all(
    ...
    [
        ...
        "Prepare validated v0.7.0 Theme Phase 3 release",
        "Verify v0.7.0 Theme Phase 3 app and Live Activity release contract",
        "Archive LifeRoute v0.7.0 Theme Phase 3",
        "Verify archived v0.7.0 Theme Phase 3 identity",
        "MARKETING_VERSION=\"$RELEASE_MARKETING_VERSION\"",
        "CURRENT_PROJECT_VERSION=\"${GITHUB_RUN_NUMBER}\"",
        "LifeRoute v0.7.0 Theme Phase 3 sent to TestFlight",
        "name: LifeRoute-v0.7.0-Theme-Phase-3-TestFlight-build-",
    ...
    "v0.7.0 Theme Phase 3 TestFlight workflow",
)
...
require("LifeRoute-v0.7.0-Theme-Phase-2-TestFlight-build-" not in workflow, "active IPA artifact must identify Phase 3")
...
require_all(
    ...
    "accumulated v0.7.0 Build A-through-E, QA, post-QA visibility/Today repair, and Theme Phase 3 preparation",
)
require(
...
require_all(
    ...
    "historical Theme Phase 2 release patch",
)
require_all(
    phase2_audit,
    ["Theme Phase 2", "phaseTwoDynamicCatalog", "Reduce Motion", "TimelineView", "Scenery"],
    "historical Theme Phase 2 release audit",
)
