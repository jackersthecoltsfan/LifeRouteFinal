...
check(
    "RBT identity remains normalized",
    (
        'replacingOccurrences(of: "Brandon Good", with: "RBT"' in SESSION_PATCH
        or 'replacingOccurrences(of: "Brandon Good", with: "the RBT"' in SESSION_PATCH
        or 'the RBT' in CORE
    ),
)
