...
# Apply the runtime features in a deterministic order.
...
python3 -m py_compile scripts/patch_route_times.py scripts/patch_transport_mode.py
plutil -lint LifeRoute/Info.plist
for js in route-times.js todos.js grocery-stores.js transport-mode.js sleek-ui.js; do
