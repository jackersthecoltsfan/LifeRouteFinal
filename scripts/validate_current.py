...
def validate_project_and_version() -> None:
    ...
    require_count(project, "ONLY_ACTIVE_ARCH = YES;", 1, "project Debug active-architecture iteration configuration")
...
def validate_clinical_and_aba(sources: dict[str, str]) -> None:
    ...
    require_all(
        ...
        [
            ...
            "ABATerminologyNormalizer.normalize(runtime.narrative)",
    ...
    require_all(
        ...
        [
            ...
            "Reorder facts only when their own words establish time or before/after relationships",
            "F-ID order alone is not chronology",
            "without IDs, a detached data list, unsupported summary, or future-plan close",
    ...
    require_all(
        ...
        [
            ...
            "REQUIRED FACT LEDGER",
            "Fact-ID order alone proves nothing",
            "Silently account for every F-ID",
            "deduplicatedFacts",
            ...
            "without a standard closing sentence",
...
def validate_timer_and_live_activity(sources: dict[str, str]) -> None:
    ...
    require_all(
        ...
        [
            ...
            "func resume(",
            "func addMinute(",
            "func adjustRemainingSeconds(by seconds:",
            "func reset()",
